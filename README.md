# Vaadin 24 Router API training

This is the training material for the Vaadin 24 Router API training. It is a multi-module maven project which contains 2 sub modules: exercises and solutions.
